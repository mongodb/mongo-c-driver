...
static int
_mongoc_stream_openssl_tls_bio_create (BIO *b);

static int
_mongoc_stream_openssl_tls_bio_destroy (BIO *b);

static int
_mongoc_stream_openssl_tls_bio_read (BIO  *b,
                                     char *buf,
                                     int   len);

static int
_mongoc_stream_openssl_tls_bio_write (BIO        *b,
                                      const char *buf,
                                      int         len);

static long
_mongoc_stream_openssl_tls_bio_ctrl (BIO  *b,
                                     int   cmd,
                                     long  num,
                                     void *ptr);

static int
_mongoc_stream_openssl_tls_bio_gets (BIO  *b,
                                     char *buf,
                                     int   len);

static int
_mongoc_stream_openssl_tls_bio_puts (BIO        *b,
                                     const char *str);
...
static BIO_METHOD gMongocStreamTlsRawMethods = {
   ...
   _mongoc_stream_openssl_tls_bio_write,
   _mongoc_stream_openssl_tls_bio_read,
   _mongoc_stream_openssl_tls_bio_puts,
   _mongoc_stream_openssl_tls_bio_gets,
   _mongoc_stream_openssl_tls_bio_ctrl,
   _mongoc_stream_openssl_tls_bio_create,
   _mongoc_stream_openssl_tls_bio_destroy
};
...
_mongoc_stream_openssl_tls_bio_destroy (BIO *b)
{
   mongoc_stream_openssl_tls_t *tls;
...
_mongoc_stream_openssl_tls_bio_puts (BIO        *b,
                                     const char *str)
{
   return _mongoc_stream_openssl_tls_bio_write (b, str, (int)strlen (str));
}
 ...
 *--------------------------------------------------------------------------
 *
 * _mongoc_stream_openssl_tls_destroy --
 *
 *       Cleanup after usage of a mongoc_stream_openssl_tls_t. Free all allocated
...
static void
_mongoc_stream_openssl_tls_destroy (mongoc_stream_t *stream)
{
   mongoc_stream_openssl_tls_t *tls = (mongoc_stream_openssl_tls_t *)stream;
 ...
 *--------------------------------------------------------------------------
 *
 * _mongoc_stream_openssl_tls_close --
 *
...
static int
_mongoc_stream_openssl_tls_close (mongoc_stream_t *stream)
{
   mongoc_stream_openssl_tls_t *tls = (mongoc_stream_openssl_tls_t *)stream;
 ...
 *--------------------------------------------------------------------------
 *
 * _mongoc_stream_openssl_tls_flush --
 *
...
static int
_mongoc_stream_openssl_tls_flush (mongoc_stream_t *stream)
{
   mongoc_stream_openssl_tls_t *tls = (mongoc_stream_openssl_tls_t *)stream;
 ...
 *--------------------------------------------------------------------------
 *
 * _mongoc_stream_openssl_tls_writev --
 *
...
static ssize_t
_mongoc_stream_openssl_tls_writev (mongoc_stream_t *stream,
                                   mongoc_iovec_t  *iov,
                                   size_t           iovcnt,
                                   int32_t          timeout_msec)
{
 ...
 *--------------------------------------------------------------------------
 *
 * _mongoc_stream_openssl_tls_readv --
 *
...
static ssize_t
_mongoc_stream_openssl_tls_readv (mongoc_stream_t *stream,
                          mongoc_iovec_t  *iov,
                          size_t           iovcnt,
                          size_t           min_bytes,
                          int32_t          timeout_msec)
 ...
 *--------------------------------------------------------------------------
 *
 * _mongoc_stream_openssl_tls_setsockopt --
 *
...
static int
_mongoc_stream_openssl_tls_setsockopt (mongoc_stream_t *stream,
                                       int              level,
                                       int              optname,
                                       void            *optval,
                                       socklen_t        optlen)
...
/**
 * mongoc_stream_openssl_tls_do_handshake:
 *
 ...
 */
bool
mongoc_stream_openssl_tls_do_handshake (mongoc_stream_t *stream,
                                        int32_t          timeout_msec)
{
   mongoc_stream_openssl_tls_t *tls = (mongoc_stream_openssl_tls_t *)stream;
...
/**
 * mongoc_stream_openssl_tls_check_cert:
 *
 * check the cert returned by the other party
 */
bool
mongoc_stream_openssl_tls_check_cert (mongoc_stream_t *stream,
                                      const char      *host)
{
   mongoc_stream_openssl_tls_t *tls = (mongoc_stream_openssl_tls_t *)stream;
   SSL *ssl;
...
_mongoc_stream_openssl_tls_get_base_stream (mongoc_stream_t *stream)
{
   return ((mongoc_stream_openssl_tls_t *)stream)->base_stream;
}


static bool
_mongoc_stream_openssl_tls_check_closed (mongoc_stream_t *stream) /* IN */
{
   mongoc_stream_openssl_tls_t *tls = (mongoc_stream_openssl_tls_t *)stream;
 ...
 *--------------------------------------------------------------------------
 *
 * mongoc_stream_openssl_tls_new --
 *
 *       Creates a new mongoc_stream_openssl_tls_t to communicate with a remote
...
mongoc_stream_t *
mongoc_stream_openssl_tls_new (mongoc_stream_t  *base_stream,
                               ...
                               int               client)
{
   ...
   tls->parent.destroy = _mongoc_stream_openssl_tls_destroy;
   tls->parent.close = _mongoc_stream_openssl_tls_close;
   tls->parent.flush = _mongoc_stream_openssl_tls_flush;
   tls->parent.writev = _mongoc_stream_openssl_tls_writev;
   tls->parent.readv = _mongoc_stream_openssl_tls_readv;
   tls->parent.setsockopt = _mongoc_stream_openssl_tls_setsockopt;
   tls->parent.get_base_stream = _mongoc_stream_openssl_tls_get_base_stream;
   tls->parent.check_closed = _mongoc_stream_openssl_tls_check_closed;
