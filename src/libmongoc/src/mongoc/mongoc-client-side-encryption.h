...
typedef struct _encrypt_string_prefix_opts_t mongoc_client_encryption_encrypt_string_prefix_opts_t;
...
BSON_DEPRECATED_FOR(mongoc_client_encryption_encrypt_string_prefix_opts_t) typedef mongoc_client_encryption_encrypt_string_prefix_opts_t
   mongoc_client_encryption_encrypt_text_prefix_opts_t;
BSON_DEPRECATED_FOR(mongoc_client_encryption_encrypt_string_suffix_opts_t) typedef mongoc_client_encryption_encrypt_string_suffix_opts_t
   mongoc_client_encryption_encrypt_text_suffix_opts_t;
BSON_DEPRECATED_FOR(mongoc_client_encryption_encrypt_string_substring_opts_t) typedef mongoc_client_encryption_encrypt_string_substring_opts_t
   mongoc_client_encryption_encrypt_text_substring_opts_t;
BSON_DEPRECATED_FOR(mongoc_client_encryption_encrypt_string_opts_t) typedef mongoc_client_encryption_encrypt_string_opts_t
...
MONGOC_EXPORT(void)
mongoc_client_encryption_encrypt_string_prefix_opts_destroy(mongoc_client_encryption_encrypt_string_prefix_opts_t *);

MONGOC_EXPORT(void)
mongoc_client_encryption_encrypt_string_suffix_opts_destroy(mongoc_client_encryption_encrypt_string_suffix_opts_t *);
...
MONGOC_EXPORT(mongoc_client_encryption_encrypt_string_opts_t *)
...
mongoc_client_encryption_encrypt_opts_set_string_opts(
   mongoc_client_encryption_encrypt_opts_t *opts, const mongoc_client_encryption_encrypt_string_opts_t *string_opts);
