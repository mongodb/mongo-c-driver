      ...
      if (mongoc_uri_option_is_int64(key)) {
         ...
         if (0 < strlen(value)) {
            if (0 == strcasecmp(value, "true")) {
               ...
               bval = false;
            } else if ((0 == strcmp(value, "1")) || (0 == strcasecmp(value, "yes")) || (0 == strcasecmp(value, "y")) ||
               ...
               MONGOC_WARNING("Deprecated boolean value for \"%s\": \"%s\", "
                              ...
                              key);
               bval = true;
            } else if ((0 == strcasecmp(value, "0")) || (0 == strcasecmp(value, "-1")) || (0 == strcmp(value, "no")) ||
                       (0 == strcmp(value, "n")) || (0 == strcmp(value, "f"))) {
               MONGOC_WARNING("Deprecated boolean value for \"%s\": \"%s\", "
...
_mongoc_uri_build_write_concern(mongoc_uri_t *uri, bson_error_t *error)
{
   ...
   bsonParse(
      ...
      find(iKeyWithType(MONGOC_URI_SAFE, boolean),
           do(mongoc_write_concern_set_w(write_concern, bsonAs(boolean) ? 1 : MONGOC_WRITE_CONCERN_W_UNACKNOWLEDGED))));
