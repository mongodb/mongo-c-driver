                     ...
                     bson_error_t *error)
{
   ...
   *outbuflen = 0;
   outbuf_capacity =
      _mongoc_common_bson_b64_ntop_calculate_target_size (raw_len);
   *outbuf = bson_malloc (outbuf_capacity);

   b64_ret = _mongoc_common_bson_b64_ntop (
                    ...
                    bson_error_t *error)
{
   ...
   decoded_len = 0;
   decoded_capacity =
      _mongoc_common_bson_b64_pton_calculate_target_size (inbuflen);
   decoded = bson_malloc (decoded_capacity);
   b64_ret = _mongoc_common_bson_b64_pton (
   ...
   *outbuflen = 0;
   outbuf_capacity = _mongoc_common_bson_b64_ntop_calculate_target_size (rawlen);
