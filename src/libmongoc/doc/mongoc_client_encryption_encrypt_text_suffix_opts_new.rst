...
A new :symbol:`mongoc_client_encryption_encrypt_text_suffix_opts_t` that must be freed with :symbol:`mongoc_client_encryption_encrypt_text_suffix_opts_destroy()`.

.. seealso::
   | :symbol:`mongoc_client_encryption_encrypt_text_suffix_opts_destroy`
