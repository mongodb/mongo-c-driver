:man_page: mongoc_client_encryption_encrypt_string_substring_opts_set_str_max_query_length
...
Sets the maximum query length for substring string search encryption options.
