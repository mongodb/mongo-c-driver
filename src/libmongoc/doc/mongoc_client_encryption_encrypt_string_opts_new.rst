:man_page: mongoc_client_encryption_encrypt_string_opts_new
...
A new :symbol:`mongoc_client_encryption_encrypt_string_opts_t` that must be freed with :symbol:`mongoc_client_encryption_encrypt_string_opts_destroy()`.

.. seealso::
   | :symbol:`mongoc_client_encryption_encrypt_string_opts_destroy`
