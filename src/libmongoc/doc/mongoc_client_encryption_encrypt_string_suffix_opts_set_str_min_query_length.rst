:man_page: mongoc_client_encryption_encrypt_string_suffix_opts_set_str_min_query_length
...
Sets the minimum query length for suffix string search encryption options.


Parameters
----------

* ``opts``: A :symbol:`mongoc_client_encryption_encrypt_string_suffix_opts_t`.
