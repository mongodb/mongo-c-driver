...
_test_oauth_parse (void)
{
   ...
   ASSERT_ERROR_CONTAINS (error, MONGOC_ERROR_AZURE, MONGOC_ERROR_AZURE_BAD_JSON, "");
...
_test_with_mock_server (void *ctx)
{
   ...
   _run_http_test_case ("empty-json", MONGOC_ERROR_AZURE, MONGOC_ERROR_AZURE_BAD_JSON, "");
