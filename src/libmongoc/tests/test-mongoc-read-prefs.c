...
test_read_prefs_mongos_max_staleness (void)
{
   ...
   mock_server_replies_to_find (
      request, MONGOC_QUERY_EXHAUST | MONGOC_QUERY_SECONDARY_OK, 0, 1, "test.test", "{}", false);
...
test_mongos_read_concern (void)
{
   ...
   mock_server_replies_to_find (request, MONGOC_QUERY_NONE, 0, 1, "db.collection", "{}", true);
