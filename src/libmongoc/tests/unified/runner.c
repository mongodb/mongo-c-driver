...
/* The test context is a global storeing state for each test.
 * When an assertion trips, causing an abort signal, the test
...
static void test_ctx_init (bson_t *test) {
    test_ctx.test = test;
...
static void check_schema_version (void) {
...
void test_install_unified (TestSuite* suite) {
