...
#undef X
   ...
   JSONSL_SPECIALf_NUMNOINT =
      (JSONSL_SPECIALf_FLOAT | JSONSL_SPECIALf_EXPONENT | JSONSL_SPECIALf_NAN | JSONSL_SPECIALf_INF)
} jsonsl_special_t;
...
JSONSL_API
jsonsl_jpr_t
jsonsl_jpr_match_state (
   jsonsl_t jsn, struct jsonsl_state_st *state, const char *key, size_t nkey, jsonsl_jpr_match_t *out);
