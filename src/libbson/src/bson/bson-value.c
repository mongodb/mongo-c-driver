                 ...
                 bson_value_t *dst)       /* OUT */
{
   ...
   case BSON_TYPE_DOUBLE:
      ...
      break;
   case BSON_TYPE_UTF8:
      BSON_ASSERT (mcd_in_range_size_t_unsigned (src->value.v_utf8.len));
   ...
   case BSON_TYPE_DBPOINTER:
      BSON_ASSERT (mcd_in_range_size_t_unsigned (src->value.v_dbpointer.collection_len));
      ...
      break;
   case BSON_TYPE_CODE:
      BSON_ASSERT (mcd_in_range_size_t_unsigned (src->value.v_code.code_len));
   ...
   case BSON_TYPE_SYMBOL:
      BSON_ASSERT (mcd_in_range_size_t_unsigned (src->value.v_symbol.len));
   ...
   case BSON_TYPE_CODEWSCOPE:
      BSON_ASSERT (mcd_in_range_size_t_unsigned (src->value.v_codewscope.code_len));
