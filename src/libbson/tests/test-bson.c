...
test_bson_install (TestSuite *suite)
{
   ...
   TestSuite_Add (
      suite, "/bson/new_from_buffer", "", test_bson_new_from_buffer);
   ...
   TestSuite_Add (
      suite, "/bson/append_overflow", "", test_bson_append_overflow);
   ...
   TestSuite_Add (suite,
                  "/bson/append_code_with_scope",
                  "",
                  test_bson_append_code_with_scope);
   TestSuite_Add (
      suite, "/bson/append_dbpointer", "", test_bson_append_dbpointer);
   TestSuite_Add (
      suite, "/bson/append_document", "", test_bson_append_document);
   ...
   TestSuite_Add (
      suite, "/bson/append_timestamp", "", test_bson_append_timestamp);
   TestSuite_Add (suite, "/bson/append_timeval", "", test_bson_append_timeval);
   TestSuite_Add (
      suite, "/bson/append_undefined", "", test_bson_append_undefined);
   ...
   TestSuite_Add (
      suite, "/bson/build_child_deep", "", test_bson_build_child_deep);
   TestSuite_Add (suite,
   ...
   TestSuite_Add (suite,
                  "/bson/reserve_buffer/errors",
                  "",
                  test_bson_reserve_buffer_errors);
   TestSuite_Add (
