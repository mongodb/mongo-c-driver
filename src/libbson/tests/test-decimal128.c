...
test_decimal128_from_string__simple (void)
{
   ...
   BSON_ASSERT (decimal128_equal (&negative_zero, 0xb040000000000000, 0x0000000000000000));
   ...
   BSON_ASSERT (decimal128_equal (&negative_number, 0xb040000000000000, 0x002bdc545d6b4b87));
...
test_decimal128_from_string__exponent_normalization (void)
{
   ...
   BSON_ASSERT (decimal128_equal (&trailing_zeros, 0x304c314dc6448d93, 0x38c15b0a00000000));
   BSON_ASSERT (decimal128_equal (&one_normalize, 0x3042314dc6448d93, 0x38c15b0a00000000));
   BSON_ASSERT (decimal128_equal (&no_normalize, 0x3040314dc6448d93, 0x38c15b0a00000000));
...
test_decimal128_from_string__zeros (void)
{
   ...
   BSON_ASSERT (decimal128_equal (&large_exponent, 0x5f20000000000000, 0x0000000000000000));
...
static void
test_decimal128_from_string_w_len__special (void)
{
   bson_decimal128_t number;
   bson_decimal128_t number_two;
   bson_decimal128_t negative_number;
...
{
   TestSuite_Add (suite, "/bson/decimal128/to_string/infinity", test_decimal128_to_string__infinity);
   TestSuite_Add (suite, "/bson/decimal128/to_string/nan", test_decimal128_to_string__nan);
   TestSuite_Add (suite, "/bson/decimal128/to_string/regular", test_decimal128_to_string__regular);
   ...
   TestSuite_Add (suite, "/bson/decimal128/from_string/scientific", test_decimal128_from_string__scientific);
   ...
   TestSuite_Add (suite, "/bson/decimal128/from_string/zero", test_decimal128_from_string__zeros);
   TestSuite_Add (suite, "/bson/decimal128/from_string/with_length", test_decimal128_from_string_w_len__special);
}
