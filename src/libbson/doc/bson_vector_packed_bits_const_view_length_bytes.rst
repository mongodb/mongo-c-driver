:man_page: bson_vector_packed_bits_const_view_length_bytes

bson_vector_packed_bits_const_view_length_bytes()
=================================================

Return the number of packed bytes in a Vector referenced by a :symbol:`bson_vector_packed_bits_const_view_t`.
...
.. seealso::
  ...
  | :symbol:`bson_vector_packed_bits_view_length_bytes`
