:man_page: bson_vector_packed_bits_view_init

bson_vector_packed_bits_view_init()
===================================

Initialize a :symbol:`bson_vector_packed_bits_view_t` from a mutable ``uint8_t`` buffer.
...
On success, the pointer and length are packaged as a :symbol:`bson_vector_packed_bits_view_t` written to ``*view_out``.
