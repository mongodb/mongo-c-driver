 ...
 *  - mcd_in_range_signed (Type, signed-value)
 *  - mcd_in_range_unsigned (Type, unsigned-value)
 *
...
MCD_IN_RANGE_SET_SIGNED (short, SHRT_MIN, SHRT_MAX)
MCD_IN_RANGE_SET_SIGNED (int, INT_MIN, INT_MAX)
MCD_IN_RANGE_SET_SIGNED (long, LONG_MIN, LONG_MAX)
MCD_IN_RANGE_SET_SIGNED (long_long, LLONG_MIN, LLONG_MAX)

MCD_IN_RANGE_SET_UNSIGNED (unsigned_char, UCHAR_MAX)
MCD_IN_RANGE_SET_UNSIGNED (unsigned_short, USHRT_MAX)
MCD_IN_RANGE_SET_UNSIGNED (unsigned_int, UINT_MAX)
MCD_IN_RANGE_SET_UNSIGNED (unsigned_long, ULONG_MAX)
MCD_IN_RANGE_SET_UNSIGNED (unsigned_long_long, ULLONG_MAX)

MCD_IN_RANGE_SET_SIGNED (int8_t, INT8_MIN, INT8_MAX)
MCD_IN_RANGE_SET_SIGNED (int16_t, INT16_MIN, INT16_MAX)
MCD_IN_RANGE_SET_SIGNED (int32_t, INT32_MIN, INT32_MAX)
MCD_IN_RANGE_SET_SIGNED (int64_t, INT64_MIN, INT64_MAX)

MCD_IN_RANGE_SET_UNSIGNED (uint8_t, UINT8_MAX)
MCD_IN_RANGE_SET_UNSIGNED (uint16_t, UINT16_MAX)
MCD_IN_RANGE_SET_UNSIGNED (uint32_t, UINT32_MAX)
MCD_IN_RANGE_SET_UNSIGNED (uint64_t, UINT64_MAX)

MCD_IN_RANGE_SET_SIGNED (ssize_t, SSIZE_MIN, SSIZE_MAX)
MCD_IN_RANGE_SET_UNSIGNED (size_t, SIZE_MAX)

#undef MCD_IN_RANGE_SET_SIGNED
#undef MCD_IN_RANGE_SET_UNSIGNED


/* Return true if the value with *signed* type is in the representable range of
 * Type and false otherwise. */
#define mcd_in_range_signed(Type, value) BSON_CONCAT3 (mcd_in_range, _##Type, _signed) (value)

/* Return true if the value with *unsigned* type is in the representable range
 * of Type and false otherwise. */
#define mcd_in_range_unsigned(Type, value) BSON_CONCAT3 (mcd_in_range, _##Type, _unsigned) (value)
