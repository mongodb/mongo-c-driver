...
bson_bool_t             mongoc_write_concern_get_fsync     (mongoc_write_concern_t *write_concern);
void                    mongoc_write_concern_set_fsync     (mongoc_write_concern_t *write_concern,
                                                            bson_bool_t             fsync_);
bson_bool_t             mongoc_write_concern_get_journal   (mongoc_write_concern_t *write_concern);
void                    mongoc_write_concern_set_journal   (mongoc_write_concern_t *write_concern,
                                                            bson_bool_t             journal);
bson_int32_t            mongoc_write_concern_get_w         (mongoc_write_concern_t *write_concern);
void                    mongoc_write_concern_set_w         (mongoc_write_concern_t *write_concern,
                                                            bson_int32_t            w);
bson_int32_t            mongoc_write_concern_get_wtimeout  (mongoc_write_concern_t *write_concern);
void                    mongoc_write_concern_set_wtimeout  (mongoc_write_concern_t *write_concern,
                                                            bson_int32_t            wtimeout_msec);
bson_bool_t             mongoc_write_concern_get_wmajority (mongoc_write_concern_t *write_concern);
