...
information:
  ...
  Hello, I'm trying to build the C driver with SSL, from mongo-c-driver-1.1.3.tar.gz. I'm on Ubuntu
...
The most current release is 1.1.3 which you can download here.
`mongo-c-driver-1.1.3.tar.gz <https://github.com/mongodb/mongo-c-driver/releases/download/1.1.3/mongo-c-driver-1.1.3.tar.gz>`_.

To build on UNIX-like systems, do the following::

  $ tar xzf mongo-c-driver-1.1.3.tar.gz
  $ cd mongo-c-driver-1.1.3
  $ ./configure
  $ make
  $ sudo make install
