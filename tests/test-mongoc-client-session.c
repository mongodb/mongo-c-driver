...
_test_session_pool_lifo (bool pooled)
{
   ...
   bson_copy_to (mongoc_client_session_get_session_id (a), &lsid_a);
   ...
   bson_copy_to (mongoc_client_session_get_session_id (b), &lsid_b);
   ...
   ASSERT_SESSIONS_MATCH (&lsid_b, mongoc_client_session_get_session_id (c));

   /* second pop returns previous push */
   d = mongoc_client_start_session (client, NULL, &error);
   ASSERT_OR_PRINT (d, error);
   ASSERT_SESSIONS_MATCH (&lsid_a, mongoc_client_session_get_session_id (d));
...
_test_session_pool_timeout (bool pooled)
{
   ...
   bson_copy_to (mongoc_client_session_get_session_id (s), &lsid);
    ...
    */
   s = mongoc_client_start_session (client, NULL, &error);
   ASSERT_SESSIONS_DIFFER (&lsid, mongoc_client_session_get_session_id (s));
