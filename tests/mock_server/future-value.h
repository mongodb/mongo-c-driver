...
typedef const mongoc_find_and_modify_opts_t
...
void
future_value_set_char_ptr_ptr (future_value_t *future_value,
                               char_ptr_ptr value);
...
future_value_set_const_mongoc_read_prefs_ptr (
   future_value_t *future_value, const_mongoc_read_prefs_ptr value);
