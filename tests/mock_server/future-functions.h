...
future_bulk_operation_execute (
   ...
   mongoc_bulk_operation_ptr bulk, bson_ptr reply, bson_error_ptr error);
...
future_client_kill_cursor (
   ...
   mongoc_client_ptr client, int64_t cursor_id);
...
future_collection_find_indexes (
   ...
   mongoc_collection_ptr collection, bson_error_ptr error);
...
future_cursor_next (
   ...
   mongoc_cursor_ptr cursor, const_bson_ptr_ptr doc);


future_t *
future_client_get_database_names (

   mongoc_client_ptr client, bson_error_ptr error);
...
future_database_get_collection_names (
   ...
   mongoc_database_ptr database, bson_error_ptr error);
...
future_gridfs_find_one (
   ...
   mongoc_gridfs_ptr gridfs, const_bson_ptr query, bson_error_ptr error);


future_t *
future_gridfs_file_remove (

   mongoc_gridfs_file_ptr file, bson_error_ptr error);


future_t *
future_gridfs_file_seek (

   mongoc_gridfs_file_ptr file, int64_t delta, int whence);
