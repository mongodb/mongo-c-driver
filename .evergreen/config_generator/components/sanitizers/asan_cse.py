...
from config_generator.components.cse.openssl import SaslOffOpenSSLCompile
...
TEST_MATRIX = [
    ('ubuntu1804', 'clang', None, 'off', ['auth'], ['server',          ], ['4.2', '4.4', '5.0',                ]),
    ('ubuntu1804', 'clang', None, 'off', ['auth'], ['server', 'replica'], [                     '6.0', 'latest']),
]
# fmt: on
