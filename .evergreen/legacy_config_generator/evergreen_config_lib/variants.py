...
all_variants = [
    Variant(
        ...
        [
            ...
            OD([("name", "link-with-cmake-windows"), ("distros", ["windows-64-vs2017-test"])]),
            OD([("name", "link-with-cmake-windows-ssl"), ("distros", ["windows-64-vs2017-test"])]),
            OD([("name", "link-with-cmake-windows-snappy"), ("distros", ["windows-64-vs2017-test"])]),
            OD([("name", "link-with-cmake-mingw"), ("distros", ["windows-64-vs2017-test"])]),
            ...
            "link-with-bson",
            OD([("name", "link-with-bson-windows"), ("distros", ["windows-64-vs2017-test"])]),
            OD([("name", "link-with-bson-mac"), ("distros", ["macos-1014"])]),
            OD([("name", "link-with-bson-mingw"), ("distros", ["windows-64-vs2013-compile"])]),
            "check-headers",
            "install-uninstall-check",
            OD([("name", "install-uninstall-check-mingw"), ("distros", ["windows-64-vs2017-test"])]),
            OD([("name", "install-uninstall-check-msvc"), ("distros", ["windows-64-vs2017-test"])]),
