...
all_variants = [
    ...
    Variant(
        ...
        [
            ...
            OD([('name', 'link-with-cmake-windows'), ('distros', ['windows-2022-latest-large'])]),
            OD([('name', 'link-with-cmake-windows-ssl'), ('distros', ['windows-2022-latest-large'])]),
            OD([('name', 'link-with-cmake-windows-snappy'), ('distros', ['windows-2022-latest-large'])]),
            OD([('name', 'link-with-cmake-mingw'), ('distros', ['windows-2022-latest-large'])]),
            ...
            'link-with-bson',
            OD([('name', 'link-with-bson-windows'), ('distros', ['windows-2022-latest-large'])]),
            OD([('name', 'link-with-bson-mac'), ('distros', ['macos-14-arm64'])]),
            OD([('name', 'link-with-bson-mingw'), ('distros', ['windows-2022-latest-large'])]),
            'check-headers',
    ...
    Variant(
        ...
        ['debug-compile-nosasl-nossl', '.7.0 .nossl .nosasl'],
