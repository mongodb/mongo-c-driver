...
all_variants = [
    ...
    Variant('darwin',
            ...
            ['.compression !.snappy !.zstd',
             ...
             '.latest .darwinssl !.nosasl .server .client-side-encryption',
             '.latest .nossl',
             '.5.0 .darwinssl !.nosasl .server .client-side-encryption',
             '.4.4 .darwinssl !.nosasl .server .client-side-encryption',
             '.4.2 .darwinssl !.nosasl .server .client-side-encryption',
             'test-dns-darwinssl',
