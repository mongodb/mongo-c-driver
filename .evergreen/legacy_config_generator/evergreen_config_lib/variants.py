...
all_variants = [
    ...
    Variant(
        ...
        [
            ...
            "test-aws-openssl-assume_role-7.0",
            "test-aws-openssl-assume_role_with_web_identity-7.0",
            "test-aws-openssl-ec2-5.0",
            "test-aws-openssl-ec2-7.0",
            "test-aws-openssl-ecs-5.0",
            "test-aws-openssl-ecs-7.0",
            "test-aws-openssl-lambda-5.0",
            "test-aws-openssl-lambda-7.0",
            "test-aws-openssl-regular-5.0",
            "test-aws-openssl-regular-7.0"
        ],
        {"CC": "clang"},
    ),
