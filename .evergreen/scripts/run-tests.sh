...
if [[ -n "${CLIENT_SIDE_ENCRYPTION}" ]]; then
  ...
  # Load secrets generated by run-mock-kms-servers.
  pushd "${det_dir:?}/.evergreen/csfle"
  {
    ...
    export MONGOC_TEST_AWSNAME2_SECRET_ACCESS_KEY="${FLE_AWS_SECRET2:?}"
    export MONGOC_TEST_AWSNAME2_ACCESS_KEY_ID="${FLE_AWS_KEY2:?}"
