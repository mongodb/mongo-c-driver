...
Configure causally consistent reads in a session. The default is false. If true, each read operations in the session will be causally ordered after the previous read or write operation. See the example code for :symbol:`mongoc_session_t`.
